...
public abstract class BlockFluidBase extends Block implements IFluidBlock
{
    ...
    static
    {
        defaultDisplacements.put(net.minecraft.src.Block.doorWood,   false);
        defaultDisplacements.put(net.minecraft.src.Block.doorIron,     false);
        defaultDisplacements.put(net.minecraft.src.Block.signPost, false);
        defaultDisplacements.put(net.minecraft.src.Block.signWall,     false);
        defaultDisplacements.put(net.minecraft.src.Block.reed,         false);
    }
