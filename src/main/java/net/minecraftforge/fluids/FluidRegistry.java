...
public abstract class FluidRegistry
{
    ...
    }.setBlock(Block.waterStill).setUnlocalizedName(Block.waterStill.getUnlocalizedName());
    ...
    }.setBlock(Block.lavaStill).setLuminosity(15).setDensity(3000).setViscosity(6000).setTemperature(1300).setUnlocalizedName(Block.lavaStill.getUnlocalizedName());
...
//        String activeModContainerName = activeModContainer == null ? "minecraft" : activeModContainer.getModId();
        String activeModContainerName = "minecraft";
