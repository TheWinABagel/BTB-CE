...
public class DefaultProps {
	...
	public static int PIPE_ITEMS_WOOD_ID = 3500;
	public static int PIPE_ITEMS_COBBLESTONE_ID = 3501;
	public static int PIPE_ITEMS_STONE_ID = 3502;
	public static int PIPE_ITEMS_IRON_ID = 3503;
	public static int PIPE_ITEMS_GOLD_ID = 3504;
	public static int PIPE_ITEMS_DIAMOND_ID = 3505;
	public static int PIPE_ITEMS_OBSIDIAN_ID = 3506;
	public static int PIPE_ITEMS_EMERALD_ID = 3507;
	public static int PIPE_ITEMS_QUARTZ_ID = 3508;
	public static int PIPE_ITEMS_LAPIS_ID = 3509;
	public static int PIPE_ITEMS_DAIZULI_ID = 3510;
	public static int PIPE_ITEMS_EMZULI_ID = 3511;
	public static int PIPE_ITEMS_CLAY_ID = 3512;

	public static int PIPE_LIQUIDS_WOOD_ID = 3520;
	public static int PIPE_LIQUIDS_COBBLESTONE_ID = 3521;
	public static int PIPE_LIQUIDS_STONE_ID = 3522;
	public static int PIPE_LIQUIDS_IRON_ID = 3523;
	public static int PIPE_LIQUIDS_GOLD_ID = 3524;
	public static int PIPE_LIQUIDS_DIAMOND_ID = 3525;
	public static int PIPE_LIQUIDS_OBSIDIAN_ID = 3526;
	public static int PIPE_LIQUIDS_EMERALD_ID = 3527;
	public static int PIPE_LIQUIDS_QUARTZ_ID = 3528;
	public static int PIPE_LIQUIDS_LAPIS_ID = 3529;
	public static int PIPE_LIQUIDS_DIAZULI_ID = 3530;

	public static int PIPE_POWER_WOOD_ID = 3540;
	public static int PIPE_POWER_COBBLESTONE_ID = 3541;
	public static int PIPE_POWER_STONE_ID = 3542;
	public static int PIPE_POWER_IRON_ID = 3543;
	public static int PIPE_POWER_GOLD_ID = 3544;
	public static int PIPE_POWER_DIAMOND_ID = 3545;
	public static int PIPE_POWER_OBSIDIAN_ID = 3546;
	public static int PIPE_POWER_EMERALD_ID = 3547;
	public static int PIPE_POWER_QUARTZ_ID = 3548;
	public static int PIPE_POWER_LAPIS_ID = 3549;
	public static int PIPE_POWER_DIAZULI_ID = 3550;

	public static int PIPE_ITEMS_VOID_ID = 3560;
	public static int PIPE_LIQUIDS_VOID_ID = 3561;
	public static int PIPE_ITEMS_SANDSTONE_ID = 3562;
	public static int PIPE_LIQUIDS_SANDSTONE_ID = 3563;
	public static int PIPE_STRUCTURE_COBBLESTONE_ID = 3564;
