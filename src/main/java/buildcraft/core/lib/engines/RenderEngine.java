...
public class RenderEngine extends TileEntitySpecialRenderer implements IInventoryRenderer {
    ...
    public RenderEngine(TileEngineBase engine) {
        this(
                engine.getBaseTexture(),
                engine.getChamberTexture(),
                engine.getTrunkTexture(TileEngineBase.EnergyStage.BLUE));
    }
    ...
    public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f) {
        ...
        if (engine != null) {
            ...
            render(
                    ...
                    engine.getBaseTexture(),
                    engine.getChamberTexture(),
                    engine.getTrunkTexture(engine.getEnergyStage()),
                    x,
                    y,
                    z);
        }
    ...
    private void render(float progress, ForgeDirection orientation, ResourceLocation baseTexture,
        ...
        GL11.glTranslatef(
                -translate[0] * chamberf * chamberc,
                -translate[1] * chamberf * chamberc,
