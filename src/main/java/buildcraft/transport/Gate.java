...
public final class Gate {
	...
	public void openGui(EntityPlayer player) {
		if (!CoreProxy.getProxy().isClientWorld(player.worldObj)) {
            ((EntityPlayerExtension) player).btb$openGui(BuildCraftTransport.INSTANCE.getModId(), GuiIds.GATES, pipe.container.worldObj, pipe.container.xCoord, pipe.container.yCoord, pipe.container.zCoord);
		}
	}
